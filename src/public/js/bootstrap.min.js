...
!(function (t, e) {
      ...
      (e._slide = function (t, e) {
        ...
        if (
          ...
          if (o.default(this._element).hasClass('slide')) {
            ...
            const g = parseInt(u.getAttribute('data-interval'), 10);
            g
              ...
              : (this._config.interval =
                  this._config.defaultInterval || this._config.interval);
            const m = d.getTransitionDurationFromElement(l);
            o.default(l)
  ...
  const nt = { ...J.DefaultType, content: '(string|element|function)' };
  const it = {
  ...
  const ut = (function () {
    ...
    return (
      ...
      (e._getConfig = function (t) {
        if (
          typeof (t = { ...lt, ...(typeof t === 'object' && t ? t : {}) })
            .target !== 'string' &&
